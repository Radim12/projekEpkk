...
@section('content')
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="d-flex">
      ...
      <a href="https://drive.google.com/drive/folders/1bYGBw1H4OXoxwLCmAkgBuSh2Axs0ObLs?usp=sharing"
      class=" btn-watch-video"><i class="bi bi-download"></i></i><span>Download Aplikasi</span></a>
