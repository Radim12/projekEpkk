      ...
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          ...
          <ul id="galeri_nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
            ...
            <li>
              <a href="{{ route('galeripokja2.index') }}"  class="active">
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $tampil->status }}</td>
                    <td>
                      <a href="{{ route('galeripengembangan.edit', $tampil->id) }}" class="btn btn-sm btn-tambah">Review</a>
                        <form action="{{ route('galeripengembangan.destroy', $tampil->gambar)}}" method="POST" class="d-inline">
                          @csrf
                          @method('DELETE')
