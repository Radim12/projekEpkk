              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $tampil->status }}</td>
                    <td>
                      <a href="{{ route('galerikesehatan.edit', $tampil->id) }}" class="btn btn-sm btn-tambah">Review</a>
                        <form action="{{ route('galerikesehatan.destroy', $tampil->gambar)}}" method="POST" class="d-inline">
                          @csrf
                          @method('DELETE')
