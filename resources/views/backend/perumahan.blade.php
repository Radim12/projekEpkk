                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>{{ $sehat1->tanggal }}</td>
                                    <td>
                                     <a href="{{ route('perumahan.edit', $sehat1->id_pokja3_bidang3)}}" class="btn btn-sm btn-tambah">Review</a>
            
                                    <form action="{{ route('perumahan.destroy', $sehat1->id_pokja3_bidang3)}}" method="POST" class="d-inline">
                                      @csrf
                                      @method('DELETE')
