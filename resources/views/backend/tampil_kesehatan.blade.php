        ...
        <div class="col-md-12 mx-auto mt-2">
          ...
          <div class="card">
            <div class="card-body mt-4">
              <form action="{{ route('kesehatan.update', $data->id_laporan_sehat) }}" method="POST"
                ...
                <div class="form-outline mb-4">
                  ...
                  <div class="form-outline mb-4 mt-3">
                    ...
                    <input type="text" name="id_laporan_sehat" id="id_laporan_sehat" class="form-control" required
