                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('galerigotongroyong.edit', $tampil->id) }}" class="btn btn-sm btn-tambah">Review</a>
                        <form action="{{ route('galerigotongroyong.destroy', $tampil->gambar)}}" method="POST" class="d-inline">
                          @csrf
                          @method('DELETE')
