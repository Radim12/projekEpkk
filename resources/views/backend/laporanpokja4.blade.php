              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                         <a href="{{ route('laporanpokja4.edit', $sehat1->id_kader_pokja4	) }}" class="btn btn-sm btn-tambah">Review</a>

                        <form action="{{ route('laporanpokja4.destroy', $sehat1->id_kader_pokja4	)}}" method="POST" class="d-inline">
                          @csrf
                          @method('DELETE')
