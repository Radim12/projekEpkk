                        ...
                        <table class="table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <a href="{{ route('pangan.edit', $sehat1->id_pokja3_bidang1) }}" class="btn btn-sm btn-tambah">Review</a>
                                  <br><br>

                                  <form action="{{ route('pangan.destroy', $sehat1->id_pokja3_bidang1)}}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
