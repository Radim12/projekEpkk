                        ...
                        <table class="table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>{{ $peng1->tanggal }}</td>
                                <td>
                                     <a href="{{ route('pendidikan.edit', $peng1->id_pokja2_bidang1)}}" class="btn btn-sm btn-tambah">Review</a>
                                     <br><br>
            
                                    <form action="{{ route('pendidikan.destroy', $peng1->id_pokja2_bidang1)}}" method="POST" class="d-inline">
                                      @csrf
                                      @method('DELETE')
