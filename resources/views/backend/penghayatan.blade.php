              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $peng1->tanggal }}</td>
                    <td>
                         <a href="{{ route('penghayatan.edit', $peng1->id_pokja1_bidang1) }}" class="btn btn-sm btn-tambah">Review</a>
                         <br>
                         <br>

                        <form action="{{ route('penghayatan.destroy', $peng1->id_pokja1_bidang1)}}" method="POST" class="d-inline">
                          @csrf
                          @method('DELETE')
