              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $got1->tanggal }}</td>
                    <td>
                         <a href="{{ route('gotongroyong.edit', $got1->id_pokja1_bidang2) }}" class="btn btn-sm btn-tambah">Review</a>

                        <form action="{{ route('gotongroyong.destroy', $got1->id_pokja1_bidang2)}}" method="POST" class="d-inline">
                          @csrf
                          @method('DELETE')
